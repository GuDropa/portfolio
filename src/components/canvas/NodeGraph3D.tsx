...
const SKILL_NODES: { label: string; icon: string; x: number; y: number; z: number }[] = [
  { label: 'Vue 3',      icon: `${DEVICON}/vuejs/vuejs-original.svg`,             x:  2.5, y:  0.8, z:  0.2 },
  { label: 'React',      icon: `${DEVICON}/react/react-original.svg`,              x:  1.6, y:  0.6, z: -1.2 },
  { label: 'TypeScript', icon: `${DEVICON}/typescript/typescript-original.svg`,    x:  1.4, y: -0.4, z:  0.5 },
  { label: 'Node.js',    icon: `${DEVICON}/nodejs/nodejs-original.svg`,            x: -1.2, y:  0.4, z:  1.5 },
  { label: 'Next.js',    icon: `${DEVICON}/nextjs/nextjs-original.svg`,            x:  1.5, y:  1.5, z: -1.4 },
  { label: 'SASS',       icon: `${DEVICON}/sass/sass-original.svg`,                x: -0.3, y: -0.6, z: -1.0 },
  { label: 'Vuetify',    icon: `${DEVICON}/vuetify/vuetify-original.svg`,          x: -0.2, y:  0.4, z:  2.2 },
  { label: 'Pinia',      icon: `${SIMPLE}/pinia/42B883`,                           x:  2.5, y:  1.2, z:  0.6 },
  { label: 'Framer',     icon: `${SIMPLE}/framer/05F`,                             x:  1.1, y: -1.1, z: -0.5 },
  { label: 'MySQL',      icon: `${DEVICON}/mysql/mysql-original.svg`,              x:  0.6, y: -1.2, z:  1.2 },
  { label: 'MongoDB',    icon: `${DEVICON}/mongodb/mongodb-original.svg`,          x:  1.2, y:  0.2, z:  1.1 },
  { label: 'Go',         icon: `${DEVICON}/go/go-original-wordmark.svg`,           x:  1.8, y: -0.8, z:  1.7 },
  { label: 'Laravel',    icon: `${DEVICON}/laravel/laravel-original.svg`,          x: -0.4, y: -1.5, z:  0.4 },
  { label: 'PHP',        icon: `${DEVICON}/php/php-original.svg`,                  x: -2.0, y:  1.3, z:  0.1 },
  { label: 'Docker',     icon: `${DEVICON}/docker/docker-original.svg`,            x: -0.8, y: -0.9, z: -2.4 },
  ...
  { label: 'Vite',       icon: `${DEVICON}/vitejs/vitejs-original.svg`,            x:  0.0, y: -1.8, z: -1.3 },
  { label: 'Angular',    icon: `${DEVICON}/angular/angular-original.svg`,          x: -0.6, y:  1.9, z: -0.5 },
  { label: 'Zustand',    icon: `${DEVICON}/react/react-original.svg`,              x: -0.2, y: -1.0, z: -1.8 },
  { label: 'Oracle',     icon: `${DEVICON}/oracle/oracle-original.svg`,            x:  0.4, y: -0.9, z:  1.5 },
  { label: 'Java',       icon: `${DEVICON}/java/java-original.svg`,                x: -2.5, y: -1.1, z:  0.3 },
  { label: 'SQL Server', icon: `${DEVICON}/microsoftsqlserver/microsoftsqlserver-plain.svg`, x:  2.0, y: -1.4, z: -0.7 },
];
